...
export const BIBLE_VERSES: BibleVerse[] = [
  ...
  },
  {
    ...
    description: 'Power to get wealth',
    packType: 'wealth',
    versions: {
  ...
  },
  {
    ...
    description: 'The Lords blessing brings wealth',
    packType: 'wealth',
    versions: {
  ...
  },
  {
    ...
    description: 'Gods abundant grace',
    packType: 'wealth',
    versions: {
  ...
  {
    verse: 'Joshua 1:8',
    description: 'Prosperity through meditation on Gods Word',
    packType: 'wealth',
    versions: {
  ...
  {
    verse: 'Psalm 1:1-3',
    description: 'Prosperity through delighting in Gods law',
    packType: 'wealth',
    versions: {
  ...
  {
    verse: 'Proverbs 4:7',
    description: 'Wisdom as principal thing',
    packType: 'wisdom',
    versions: {
  ...
  {
    verse: 'Proverbs 9:10',
    description: 'Fear of the Lord as wisdom beginning',
    packType: 'wisdom',
    versions: {
  ...
  {
    verse: 'Colossians 2:2-3',
    description: 'Treasures of wisdom in Christ',
    packType: 'wisdom',
    versions: {
      NKJV: 'That their hearts may be encouraged, being knit together in love, and attaining to all riches of the full assurance of understanding, to the knowledge of the mystery of God, both of the Father and of Christ, in whom are hidden all the treasures of wisdom and knowledge',
      ...
      NIV: 'My goal is that they may be encouraged in heart and united in love, so that they may have the full riches of complete understanding, in order that they may know the mystery of God, namely, Christ, in whom are hidden all the treasures of wisdom and knowledge',
      ESV: 'That their hearts may be encouraged, being knit together in love, to reach all the riches of full assurance of understanding and the knowledge of Gods mystery, which is Christ, in whom are hidden all the treasures of wisdom and knowledge'
    }
  },
  {
    verse: 'Proverbs 2:6',
    description: 'The Lord gives wisdom',
    packType: 'wisdom',
    versions: {
  ...
  },
  {
    ...
    description: 'Wisdom as protection',
    packType: 'wisdom',
    versions: {
  ...
  },
  {
    ...
    description: 'Value of wisdom',
    packType: 'wisdom',
    versions: {
      NKJV: 'Happy is the man who finds wisdom, And the man who gains understanding; For her proceeds are better than the profits of silver, And her gain than fine gold',
