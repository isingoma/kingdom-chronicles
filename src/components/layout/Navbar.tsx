        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-4">
              <Link 
                to="/games" 
                className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md transition-all duration-300 hover:bg-indigo-50"
              >
                Games
              </Link>
              <Link 
                to="/leaderboard" 
                className="flex items-center text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md transition-all duration-300 hover:bg-indigo-50"
              >
